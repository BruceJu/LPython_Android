...
public class FragmentArticle_TouTiao extends Fragment {
    protected View rootView;

    public static FragmentArticle_TouTiao newInstance(){
        FragmentArticle_TouTiao fragment = new FragmentArticle_TouTiao();
        return fragment;
    }


    public FragmentArticle_TouTiao() {
